...
public class WeatherProvider extends ContentProvider {
    ...
    public Cursor query(@NonNull Uri uri, @Nullable String[] projection,
        ...
        switch (sUriMatch.match(uri)) {
            case CODE_WEATHER_WITH_DATE: {
                ...
                String[] selectionArguments = {normalizedUtcDateString};
    ...
    public String getType(@NonNull Uri uri) {
        throw new RuntimeException("We are not implementing getType in UdacitySunshine.");
    }

    @Nullable
    @Override
    public Uri insert(@NonNull Uri uri, @Nullable ContentValues values) {
        throw new RuntimeException("We are not implementing insert in UdacitySunshine.");
    }
    ...
    public int update(@NonNull Uri uri, @Nullable ContentValues values, @Nullable String selection, @Nullable String[] selectionArgs) {
        throw new RuntimeException("We are not implementing update in UdacitySunshine.");
    }
