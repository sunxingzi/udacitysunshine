...
public final class NetworkUtils {
    ...
    public static URL getUrl(Context context){
        if(SunshinePreferences.isLocationLatLonAvailable(context)){
            ...
            Log.e("666", "getUrl: buildUrlWithLocationQuery(locationQuery) "+ buildUrlWithLocationQuery(locationQuery) );
    ...
    private static URL buildUrlWithLatitudeLongitude(Double latitude,Double longitude){
        ...
        try {
            ...
            Log.e("666", "buildUrlWithLatitudeLongitude: "+weatherQueryUrl );
    ...
    private static URL buildUrlWithLocationQuery(String locationQuery){
        ...
        try {
            URL weatherQueryUrl = new URL(weatherQueryUri.toString());
            Log.e("666", "buildUrlWithLocationQuery: "+weatherQueryUrl );
            return weatherQueryUrl;
        } catch (MalformedURLException e) {
            e.printStackTrace();
            return null;
    ...
    public static String getResponseFromHttpUrl(URL url)throws IOException{
       ...
       try{
           ...
           scanner.close();
           Log.e("666", "getResponseFromHttpUrl: "+response );
           return response;
       }finally {
