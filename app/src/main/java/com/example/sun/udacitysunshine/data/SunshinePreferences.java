...
public final class SunshinePreferences {
    ...
    public static void setWeatherLocation(Context context,String location){
        SharedPreferences sp = PreferenceManager.getDefaultSharedPreferences(context);
        SharedPreferences.Editor editor = sp.edit();
        String keyForLocation = context.getString(R.string.pref_location_key);
        editor.putString(keyForLocation,location);
        Log.e("sp", "setWeatherLocation: "+location);
        editor.apply();
    }
    ...
    public static String getPreferredWeatherLocation(Context context){
        ...
        Log.e("sp", "getPreferredWeatherLocation:sp.getString(keyForLocation,defaultLocation) "+sp.getString(keyForLocation,defaultLocation));
        return sp.getString(keyForLocation,defaultLocation);
    }

    public static void setUnit(Context context,String chooseUnit){
        SharedPreferences sp = PreferenceManager.getDefaultSharedPreferences(context);
        SharedPreferences.Editor editor = sp.edit();
        String keyForUnits = context.getString(R.string.pref_units_key);
        editor.putString(keyForUnits,chooseUnit);
        editor.apply();
    }
    ...
    public static void setNotificationEnabledStatus (Context context,boolean enabledStatus){
        SharedPreferences sp = PreferenceManager.getDefaultSharedPreferences(context);
        SharedPreferences.Editor editor = sp.edit();
        String displayNotificationsKey = context.getString(R.string.pref_enable_notifications_key);
        editor.putBoolean(displayNotificationsKey,enabledStatus);
        editor.apply();
    }
